...
You just used your error to update the model. This is called back propogation. Now since you have a solid understanding of neural network, you can code this using [keras](https://keras.io/){:target="_blank"} with couple of lines. Recently [Geoff hinton](https://research.google.com/pubs/GeoffreyHinton.html){:target="_blank"} criticise his work by saying "throw it away and start all over again" in search of AI that actually learn like humans with no labels with less examples. [Synthetic gradients](https://deepmind.com/research/publications/understanding-synthetic-gradients-and-decoupled-neural-interfaces/){:target="_blank"}, used by [deep mind](https://deepmind.com/){:target="_blank"}  to compute the loss function is also worth taking a look. 